...
const ContactUs = () => {
  return (
    ...
    >
      ...
      {/* Content */}
      <div className="text-white  pt-32 relative">
        ...
        <div className="w-11/12 md:w-9/12 lg:w-8/12 mx-auto my-10 md:my-20 md:flex justify-between gap-6">
          <div className="w-full md:w-1/2 flex flex-col gap-7">
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-200">empowerhub@gmail.com</p>
              </div>
            </div>
          </div>
          ...
          <div className="w-full md:w-1/2 mt-10 md:mt-0">
            ...
            <form className="w-full">
              ...
              <div className="">
                <button className="btn w-full text-white border-none bg-cyan-500">
                  Send
                </button>
              </div>
            </form>
